...
def send_important_numbers(bot, message):
    ...
    if str(message.chat.id) in TG_CHAT_IDS:
        important_numbers = (
            "Важные номера:\n"
            "Медведь Светлана Викторовна: +79788402746\n"
            "Куликова Виктория Петровна: +79788594443\n"
            "Дорогина Марина Игоревна: +79787618520\n"
            "Цёма Валентина Петровна: +79787618492\n"
            "Дурка: +73652272222\n"
            "Телефон доверия: +88002000122\n"
            "Служба психологической помощи: +84959895050\n"
            "Техподдержка школы: +88005553535\n"
        )
